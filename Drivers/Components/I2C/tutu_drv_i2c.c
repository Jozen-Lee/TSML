...
/**
  * @brief  Configure IIC_PIN
  * @retval 0,success
  *         1,fail
  */
unsigned char IIC_Setting(IIC_PIN_Typedef* iic_pin,GPIO_TypeDef *gpiox, uint32_t scl_pinx, uint32_t sda_pinx)
{
	iic_pin->IIC_GPIO_PORT = gpiox;
	iic_pin->IIC_SCL_PIN = scl_pinx;
	iic_pin->IIC_SDA_PIN = sda_pinx;
 if (scl_pinx == GPIO_PIN_0)
			iic_pin->IIC_SCL_PIN_NUM = 0;
	else if (scl_pinx == GPIO_PIN_1)
			iic_pin->IIC_SCL_PIN_NUM = 1;
	else if (scl_pinx == GPIO_PIN_2)
			iic_pin->IIC_SCL_PIN_NUM = 2;
	else if (scl_pinx == GPIO_PIN_3)
			iic_pin->IIC_SCL_PIN_NUM = 3;
	else if (scl_pinx == GPIO_PIN_4)
			iic_pin->IIC_SCL_PIN_NUM = 4;
	else if (scl_pinx == GPIO_PIN_5)
			iic_pin->IIC_SCL_PIN_NUM = 5;
	else if (scl_pinx == GPIO_PIN_6)
			iic_pin->IIC_SCL_PIN_NUM = 6;
	else if (scl_pinx == GPIO_PIN_7)
			iic_pin->IIC_SCL_PIN_NUM = 7;
	else if (scl_pinx == GPIO_PIN_8)
			iic_pin->IIC_SCL_PIN_NUM = 8;
	else if (scl_pinx == GPIO_PIN_9)
			iic_pin->IIC_SCL_PIN_NUM = 9;
	else if (scl_pinx == GPIO_PIN_10)
			iic_pin->IIC_SCL_PIN_NUM = 10;
	else if (scl_pinx == GPIO_PIN_11)
			iic_pin->IIC_SCL_PIN_NUM = 11;
	else if (scl_pinx == GPIO_PIN_12)
			iic_pin->IIC_SCL_PIN_NUM = 12;
	else if (scl_pinx == GPIO_PIN_13)
			iic_pin->IIC_SCL_PIN_NUM = 13;
	else if (scl_pinx == GPIO_PIN_14)
			iic_pin->IIC_SCL_PIN_NUM = 14;
	else if (scl_pinx == GPIO_PIN_15)
			iic_pin->IIC_SCL_PIN_NUM = 15;
	else return 1;
	
	if (sda_pinx == GPIO_PIN_0)
			iic_pin->IIC_SDA_PIN_NUM = 0;
	else if (sda_pinx == GPIO_PIN_1)
			iic_pin->IIC_SDA_PIN_NUM = 1;
	else if (sda_pinx == GPIO_PIN_2)
			iic_pin->IIC_SDA_PIN_NUM = 2;
	else if (sda_pinx == GPIO_PIN_3)
			iic_pin->IIC_SDA_PIN_NUM = 3;
	else if (sda_pinx == GPIO_PIN_4)
			iic_pin->IIC_SDA_PIN_NUM = 4;
	else if (sda_pinx == GPIO_PIN_5)
			iic_pin->IIC_SDA_PIN_NUM = 5;
	else if (sda_pinx == GPIO_PIN_6)
			iic_pin->IIC_SDA_PIN_NUM = 6;
	else if (sda_pinx == GPIO_PIN_7)
			iic_pin->IIC_SDA_PIN_NUM = 7;
	else if (sda_pinx == GPIO_PIN_8)
			iic_pin->IIC_SDA_PIN_NUM = 8;
	else if (sda_pinx == GPIO_PIN_9)
			iic_pin->IIC_SDA_PIN_NUM = 9;
	else if (sda_pinx == GPIO_PIN_10)
			iic_pin->IIC_SDA_PIN_NUM = 10;
	else if (sda_pinx == GPIO_PIN_11)
			iic_pin->IIC_SDA_PIN_NUM = 11;
	else if (sda_pinx == GPIO_PIN_12)
			iic_pin->IIC_SDA_PIN_NUM = 12;
	else if (sda_pinx == GPIO_PIN_13)
			iic_pin->IIC_SDA_PIN_NUM = 13;
	else if (sda_pinx == GPIO_PIN_14)
			iic_pin->IIC_SDA_PIN_NUM = 14;
	else if (sda_pinx == GPIO_PIN_15)
			iic_pin->IIC_SDA_PIN_NUM = 15;	
	else return 1;
