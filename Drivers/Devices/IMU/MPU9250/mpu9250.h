...
//磁力计校准数据的存储地址
#define MAG_DATA_BLOCK 	1			/*磁力计校准数据存储的BLOCK序号*/
#define MAG_DATA_SECTOR 1			/*磁力计校准数据存储的SECTOR序号*/
/* Private type --------------------------------------------------------------*/	 

/* Exported ------------------------------------------------------------------*/
unsigned char MPU_Init(IIC_PIN_Typedef *hiic); 																															//!<初始化MPU9250
...
unsigned char MPU_Get_Gyroscope(IIC_PIN_Typedef *hiic,float *gx,float *gy,float *gz);       
unsigned char MPU_Get_Accelerometer(IIC_PIN_Typedef *hiic,float *ax,float *ay,float *az);   
unsigned char MPU_Get_Magnetometer(IIC_PIN_Typedef *hiic,float *mx,float *my,float *mz);
